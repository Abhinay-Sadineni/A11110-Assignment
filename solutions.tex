...
\textbf{Soltion:}Download and exceute the code 
\begin{lstlisting}
...
\item its tends to one as we approch infinity
\end{enumerate}
\begin{lstlisting}
...
\item its tends to zero as we approch infinity
\end{enumerate}
\begin{lstlisting}
...
and plot its CDF.
\textbf{Solution:}
Refer the figure \ref{fig:vni_cdf}
\begin{lstlisting}
